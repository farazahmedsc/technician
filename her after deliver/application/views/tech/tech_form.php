...
<head>
  ...
  <title>Technician Forms | Hers test</title>
  <!-- plugins:css -->
              ...
              <div id="first_Form">
                  <div class="row" id="initialForm">
                    ...
                    <div class="col-md-6" style="display: none;">
                      <div class="form-group">
                        <label>URL*</label>
                        <input type="text" class="form-control" name="url" placeholder="url " value="tech_form">
                      </div>
                    </div><!-- col-md-6 End-->
...
<script>
    ...
    if (unit_type == "Package_Unit") {
        ...
        fulltime == 'Yes' ? $("#second_acCoil").show() : $("#second_centralGas").show();
...
<script>
    ...
    if (unit_type == "Package_Unit") {
        ...
        fulltime == 'Yes' ? $("#third_acCoil").show() : $("#third_centralGas").show();
