        ...
        <div class="row w-100 mx-0">
          ...
          <div class="col-lg-4 mx-auto">
            ...
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <form class="pt-3" action="<?php echo base_url(); ?>home" method="post">
                ...
                <br><center><a href="<?php echo base_url();?>technician_login" class="btn btn-warning font-weight-medium ">Technician Login</a></center> 
