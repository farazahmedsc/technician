            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover table-striped" id="techTable">
                      <thead>
                        <tr>
                          <th>Id</th>
                          <th>Name</th>
                      ...
                      <?php
                          foreach($technician_list as $t){ ?>
                          <!-- t_name, t_email, t_phone, t_username, t_password -->
                          <tr>
                            <td><a href="<?php echo base_url();?>technician/update/<?php echo $t->t_id; ?>"><?php echo $t->t_id; ?></a></td>
                            <td><?php echo $t->t_name; ?></td>                           
                            <td><?php echo $t->t_email; ?></td>
                            <td><?php echo $t->t_phone; ?></td>
                            <td><?php echo $t->t_username; ?></td>
                            <td><?php echo ($t->t_active  ==  'checked') ?  'Yes' :  'No'; ?></td>
                          </tr>
                            <?php }
                          ?>
