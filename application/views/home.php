            ...
            <!-- <div class="col-md-6 grid-margin stretch-card">
              <div class="card tale-bg">
                <div class="card-people mt-auto">
                  <img src="<?php echo base_url(); ?>asset/images/dashboard/people.svg" alt="people">
                ...
                <div class="col-md-3 mb-4 stretch-card transparent">
                  <div class="card card-tale">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo $Pu ?></p>
                      <p>Total Entries</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-3 mb-4 stretch-card transparent">
                  <div class="card card-dark-blue">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo $Cs ?></p>
                      <p>Total Entries</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-3 mb-4 stretch-card transparent">
                  <div class="card card-light-blue">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo $Hp ?></p>
                      <p>Total Entries</p>
                    </div>
                  </div>
                </div>
                <div class="col-md-3 mb-4 stretch-card transparent">
                  <div class="card card-light-danger">
                    <div class="card-body">
                      ...
                      <p class="fs-30 mb-2"><?php echo $Du ?></p>
                      <p>Total Entries</p>
                    </div>
                  </div>
                </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <ul class="icon-data-list">
                    <li>
                      <div class="d-flex">
                        <img src="<?php echo base_url(); ?>asset/images/faces/face1.jpg" alt="user">
                        <div>
                    ...
                    <li>
                      <div class="d-flex">
                        <img src="<?php echo base_url(); ?>asset/images/faces/face2.jpg" alt="user">
                        <div>
                    ...
                    <li>
                      <div class="d-flex">
                      <img src="<?php echo base_url(); ?>asset/images/faces/face3.jpg" alt="user">
                     <div>
                    ...
                    <li>
                      <div class="d-flex">
                        <img src="<?php echo base_url(); ?>asset/images/faces/face4.jpg" alt="user">
                        <div>
                    ...
                    <li>
                      <div class="d-flex">
                        <img src="<?php echo base_url(); ?>asset/images/faces/face5.jpg" alt="user">
                        <div>
