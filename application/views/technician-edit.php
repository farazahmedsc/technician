...
<head>
  ...
  <title>Update Technician | Hers test</title>
  <!-- plugins:css -->
            ...
            <div class="col-12 grid-margin stretch-card">
              ...
              <div class="modal-dialog">
                  ...
                  <div class="modal-content">
                      ...
                      <form method="post" action="<?php echo base_url(); ?>technician/delete/<?php echo $technician_single->t_id; ?>">
                  ...
                  <form class="forms-sample" method="post" action="<?php echo base_url();?>technician/update_technician/<?php echo $technician_single->t_id?>" enctype="multipart/form-data">

                    <div class="row" id="initialForm">
                      <div class="col-md-12">
                        <div class="form-group">
                            <label>Technician Name*</label>
                            <input type="text" class="form-control" name="t_name" placeholder="Technician Name" value="<?php echo $technician_single->t_name?>" required >
                        </div>
                      </div><!-- col-md-6 End-->
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                            <label>Email </label>
                            <input type="text" class="form-control" name="t_email" placeholder="email"  value="<?php echo $technician_single->t_email; ?>">
                        </div>
                      </div><!-- col-md-6 End-->
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                            <label>Phone*</label>
                            <input type="text" class="form-control" name="t_phone" placeholder="Phone" value="<?php echo $technician_single->t_phone?>" required>
                        </div>
                      </div><!-- col-md-6 End-->
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="t_username" placeholder="username"  value="<?php echo $technician_single->t_username?>">
                        </div>
                      </div><!-- col-md-6 End-->
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="t_password" placeholder="Password" value="<?php echo $technician_single->t_password?>" required>
                        </div>
                      </div><!-- col-md-6 End-->
                      ...
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <label class="form-check-label">
                            <input type="checkbox" class="form-check-input" name="t_active"  <?php echo ($technician_single->t_active  ==  'checked') ?  'checked' :  ''; ?>>
                              Active
